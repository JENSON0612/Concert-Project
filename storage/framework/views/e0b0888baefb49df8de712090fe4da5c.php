...
<link rel="stylesheet" href="<?php echo e(asset('css/addConcert.css')); ?>">

<div class="addConcert">
    <h3 id="addConcertTitle">ADD CONCERT</h3>
</div>
<div class="addConcertContainer">
    <form action="<?php echo e(route('addConcert')); ?>" method="POST" enctype='multipart/form-data'>
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\OneDrive - Southern University College\Desktop\SUC\Project(Coding)\concertProject\concertProject\resources\views/addConcert.blade.php ENDPATH**/ ?>