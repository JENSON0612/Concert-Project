...
<link rel="stylesheet" href="<?php echo e(asset('css/concertSection.css')); ?>">
    ...
    <h5>SELECT SEAT</h5>
        <form action="<?php echo e(route('hiddenTicket')); ?>" method="post" enctype='multipart/form-data'>
            <?php echo csrf_field(); ?>
            <p>
                <label for="seatPrice">Seat Price:</label>
                <select name="seatPrice" id="seatPrice">
                    <option value="<?php echo e($concert->seatPrice1); ?>">RM<?php echo e($concert->seatPrice1); ?><input type="hidden" class="hidden" name="type" value="A"></option>
                    <option value="<?php echo e($concert->seatPrice2); ?>">RM<?php echo e($concert->seatPrice2); ?>  <input class="hidden" type="hidden" name="type" value="B"></option>
                    <option value="<?php echo e($concert->seatPrice3); ?>"><input type="hidden" class="hidden" name="type" value="C">RM<?php echo e($concert->seatPrice3); ?></option>
                </select>
            </p>
            ...
            <p><label for="ticketQuantity">Ticket Quantity:</label>
                <input type="number" id="ticketQuantity" name="ticketQuantity" min="1" value="1"></p>

            <p id="totalAmount">TOTAL AMOUNT: <span id="displayTotal">RM 0</span></p>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\JENSON\web development\projectConcert\concertProject\resources\views/concertSection.blade.php ENDPATH**/ ?>