...
<link rel="stylesheet" href="<?php echo e(asset('css/concertSection.css')); ?>">
    ...
    <?php $__currentLoopData = $concert; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concerts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="section1">
    ...
    <div class="displaySelected">
        ...
        <p>
            <select name="seatPrice" id="seatPrice">
                <option value="<?php echo e($concert->seatPrice1); ?>">A</option>
                <option value="<?php echo e($concert->seatPrice2); ?>">B</option>
                <option value="<?php echo e($concert->seatPrice3); ?>">C</option>
            </select>
        </p>
        <br>
        <h5>TICKET QUANTITY</h5>
        <p><input type="number" id="ticketQuantity" name="ticketQuantity" min="1" value="1"></p>
        <p id="totalAmount" name="totalAmount" value="0">TOTAL AMOUNT: RM 0</p>
        <a id="payLink" href="<?php echo e(route('payment')); ?>">PAY</a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\OneDrive - Southern University College\Desktop\SUC\Project(Coding)\concertProject\concertProject\resources\views/concertSection.blade.php ENDPATH**/ ?>