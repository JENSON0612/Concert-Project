...
<div class="firstSection">
    ...
    <div class="fsright col-md-6">
        <img id="photo2" src="{{asset('image/fsrightphoto2.jpg')}}" alt="jpg">
         <img id="photo1" src="{{asset('image/fsrightphoto.jpeg')}}" alt="jpeg">
         <img id="photo3" src="{{asset('image/fsrightphoto3.jpeg')}}" alt="jpeg">
    </div>
</div>
<div class="secondSection">
    <div class="scdUpperSection">
        <img src="{{asset('image/scdphoto1.jpeg')}}" alt="jpeg">
    </div>
...
<div class="thirdSection">
    ...
    <div class="thirdPhoto">
        <div class="photo1 col-md-4">
            <img src="{{asset('image/thirdPhoto1.jpeg')}}" alt="jpeg">
        </div>
        <div class="photo2 col-md-4">
            <img src="{{asset('image/thirdPhoto2.jpeg')}}" alt="jpeg">
        </div>
        <div class="photo3 col-md-4">
            <img src="{{asset('image/thirdPhoto3.png')}}" alt="png">
        </div>
    </div>
</div>
